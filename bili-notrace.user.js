...
// @namespace    https://github.com/UesugiKou/Bili-Notrace
// @version      1.0.1
...
// @license      MIT
// @updateURL    https://UesugiKou.github.io/Bili-Notrace/bili-notrace.user.js
// @downloadURL  https://UesugiKou.github.io/Bili-Notrace/bili-notrace.user.js
// ==/UserScript==
...
(function () {
    ...
    // ==================== 初始化 ====================
    function init() {
        // 安全地获取版本号（兼容 GM_info 不可用的情况）
        let scriptVersion = 'unknown';
        try {
            if (typeof GM_info !== 'undefined') {
                scriptVersion = GM_info.script.version || scriptVersion;
            } else if (typeof GM !== 'undefined' && GM.info) {
                scriptVersion = GM.info.script.version || scriptVersion;
            }
        } catch (e) {
            // 忽略版本获取失败，不影响主逻辑
        }
        log.info('Bilibili NoTrace 已加载 v' + scriptVersion);
